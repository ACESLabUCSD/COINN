...
$onni_path/bin/onni -f 6 -i 1024 -w 14 -g 1 --ba 9 --br 7 --bs 9 --bl 8 --sup --setup -k 1 -t 4 --dir $files_path/layer-10-Bottleneck/RELU3/ --layerid 10
...
$onni_path/bin/onni -f 2 -i 2048 -w 7 -g 1 --ba 9 --br 7 --sup --setup -k 1 -t 4 --dir $files_path/layer-16-Bottleneck/RELU3/ --layerid 16
...
$onni_path/bin/onni -f 6 -i 2048 -w 7 -g 1 --ba 9 --br 7 --bs 9 --bl 8 --sup --setup -k 1 -t 4 --dir $files_path/layer-17-Bottleneck/RELU3/ --layerid 17
...
$onni_path/bin/onni -f 4 --bw 16 -i 2048 -o 1000 -w 1 -g 1 --ba 16 -z 0 --sup --setup -k 1 -t 4 --dir $files_path/layer-18-LINEAR/ --layerid 18
