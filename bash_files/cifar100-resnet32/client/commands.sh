...
$onni_path/bin/onni -f 2 -i 16 -w 32 -g 1 --ba 9 --br 7 --sup --setup -k 2 -t 4 --dir $files_path/layer-5-BasicBlock/RELU2/ --layerid 5
...
$onni_path/bin/onni -f 2 -i 16 -w 32 -g 1 --ba 9 --br 6 --sup --setup -k 2 -t 4 --dir $files_path/layer-6-BasicBlock/RELU2/ --layerid 6
...
$onni_path/bin/onni -f 4 --bw 16 -i 64 -o 100 -w 1 -g 1 --ba 16 -z 0 --sup --setup -k 2 -t 4 --dir $files_path/layer-17-LINEAR/ --layerid 17
