...
$onni_path/bin/onni -f 2 -i 16 -w 32 -g 1 --ba 8 --br 8 --sup  -k 1 -t 4 --dir $files_path/layer-5-BasicBlock/RELU2/ --layerid 5
...
$onni_path/bin/onni -f 2 -i 16 -w 32 -g 1 --ba 10 --br 5 --sup  -k 1 -t 4 --dir $files_path/layer-6-BasicBlock/RELU2/ --layerid 6
...
$onni_path/bin/onni -f 2 -i 64 -w 1 -g 1 --ba 8 --br 6 --sup  -k 1 -t 4 --dir $files_path/layer-17-SUMPOOL2D/ --layerid 17
cp $files_path/layer-17-SUMPOOL2D/layer_17_OutputA.txt $files_path/layer-18-LINEAR/layer_18_InputA.txt
$onni_path/bin/onni -f 4 --bw 16 -i 64 -o 100 -w 1 -g 1 --ba 16 -z 0 --sup  -k 1 -t 4 --dir $files_path/layer-18-LINEAR/ --layerid 18
cp $files_path/layer-18-LINEAR/layer_18_OutputA.txt $files_path/layer-19-ARGMAX/layer_19_InputA.txt
$onni_path/bin/onni -f 7 -e 100 --sup  -k 1 -t 1 --dir $files_path/layer-19-ARGMAX/ --layerid 19
